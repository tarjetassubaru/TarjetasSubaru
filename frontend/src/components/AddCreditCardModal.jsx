...
import { createCreditCard } from "../api/banks";
...
export default function AddCreditCardModal({ bankId, onClose, onCreated }) {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50">
      <div className="bg-[#0f1117] border border-gray-800 rounded-xl w-full max-w-sm mx-4 p-6 shadow-2xl">
        <h3 className="text-lg font-semibold text-gray-200 mb-4">Nueva Tarjeta de Credito</h3>
        <form onSubmit={handleSubmit}>
          ...
          <label className="block mb-1 text-sm text-gray-400">Cupo utilizado actual</label>
          <input
            type="number"
            value={usedCredit}
